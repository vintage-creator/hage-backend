...
-- CreateEnum
CREATE TYPE "DocType" AS ENUM ('COMPANY_REGISTRATION_CERTIFICATE', 'TAX_REGISTRATION_CERTIFICATE');
...
-- CreateEnum
CREATE TYPE "ShipmentStatus" AS ENUM ('PENDING', 'ACCEPTED', 'IN_WAREHOUSE', 'IN_TRANSIT', 'PICKED_UP', 'DELIVERED', 'COMPLETED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('COMMERCIAL_INVOICE', 'PACKING_LIST', 'WAYBILL', 'BILL_OF_LADING', 'OTHER');
